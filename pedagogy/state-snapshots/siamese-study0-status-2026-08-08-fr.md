# Study 0 — état d'étape du 8 août 2026

**Preservation mode:** verbatim pedagogical snapshot. The body below is intentionally preserved as originally explained in conversation. Future corrections or amplifications should be linked, not silently rewritten.
...
PR #5 formalise ce comportement : le harness n’altère pas le résultat scientifique, mais empêche l’exécution du coverage tant que cette difficulté de faisabilité n’est pas traitée.
...
PR #6 existe précisément pour documenter cette faisabilité **sans calculer de coverage et sans lire les résultats historiques**.
